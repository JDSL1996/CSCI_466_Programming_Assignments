...
if __name__ == '__main__':
    ...
    encap_tbl_D = {'H2': ('5', '6')}    # table used to encapsulate network packets into MPLS frames
    # in label: {in interface: (out label (forward), out int)} (dict of dict of list)
    frwd_tbl_D = {'5': {0: ('9', 1)}}     # table used to forward MPLS frames
